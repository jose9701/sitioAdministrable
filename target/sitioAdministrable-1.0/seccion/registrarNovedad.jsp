                ...
                <form id="frmRegistrarNovedad">
                    ...
                    <div class="row" style="padding-top: 15px">
                        <div class="col-md-2 col-md-offset-7">
                            <a style="cursor: pointer;" onclick="redirigir('Consultar','Novedades')" class="btn btn-danger">Volver</a>
                        </div>
                        <div class="col-md-2">
                            <input type="hidden" name="registrarNovedad">
